...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_ENTRADA = 3,                    /* ENTRADA  */
  YYSYMBOL_SAIDA = 4,                      /* SAIDA  */
  YYSYMBOL_FIM = 5,                        /* FIM  */
  YYSYMBOL_FACA = 6,                       /* FACA  */
  YYSYMBOL_ENQUANTO = 7,                   /* ENQUANTO  */
  YYSYMBOL_ZERA = 8,                       /* ZERA  */
  YYSYMBOL_INC = 9,                        /* INC  */
  YYSYMBOL_IGUAL = 10,                     /* IGUAL  */
  YYSYMBOL_ABREPAR = 11,                   /* ABREPAR  */
  YYSYMBOL_FECHAPAR = 12,                  /* FECHAPAR  */
  YYSYMBOL_ID = 13,                        /* ID  */
  YYSYMBOL_YYACCEPT = 14,                  /* $accept  */
  YYSYMBOL_program = 15,                   /* program  */
  YYSYMBOL_cmd = 16,                       /* cmd  */
  YYSYMBOL_cmds = 17,                      /* cmds  */
  YYSYMBOL_varlist = 18                    /* varlist  */
};
...
{
       0,    32,    32,    64,    75,    86,    97,   120,   130,   138,
     151
};
#endif
...
static const char *const yytname[] =
{
  ...
  "FIM", "FACA", "ENQUANTO", "ZERA", "INC", "IGUAL", "ABREPAR", "FECHAPAR",
  "ID", "$accept", "program", "cmd", "cmds", "varlist", YY_NULLPTR
};
...
{
      -1,    -9,     9,   -15,    -3,   -15,    -9,   -15,    11,    -5,
       3,    12,    19,   -15,    -2,    16,    15,    17,    20,   -15,
      19,   -15,    18,    22,    23,   -15,     8,   -15,   -15,   -15
};
...
{
      21,     6,     1,    19,     3,     9,    10,    11,    15,     5,
       7,    20,    21,    29,    16,     9,    10,    11,     9,    10,
      11,    20,    22,    17,    12,     9,    10,    11,    23,    18,
      24,    20,    26,    25,    27,    28,     8
};

static const yytype_int8 yycheck[] =
{
      14,     4,     3,     5,    13,     7,     8,     9,    13,     0,
      13,    13,    26,     5,    11,     7,     8,     9,     7,     8,
       9,    13,     6,    11,    13,     7,     8,     9,    13,    10,
      13,    13,    22,    13,    12,    12,     6
};
...
{
       0,     3,    15,    13,    18,     0,     4,    13,    18,     7,
       8,     9,    13,    16,    17,    13,    11,    11,    10,     5,
      13,    16,     6,    13,    13,    13,    17,    12,    12,     5
};
...
#line 97 "ProvolOne.y"
    ...
    size_t cmds_len = strlen(yyvsp[-1]);
    size_t cond_len = strlen(yyvsp[-3]);
    size_t while_len = 15 + cmds_len + cond_len;

    char* condicao = yyvsp[-3];
    char* o_queFazer = yyvsp[-1];
...
#line 120 "ProvolOne.y"
        ...
        yyval = strcat(buf,yyvsp[0]);
        free(yyvsp[0]);

    }
#line 1208 "ProvolOne.tab.c"
    break;
...
#line 1218 "ProvolOne.tab.c"
    break;

  case 9: /* varlist: varlist ID  */
#line 138 "ProvolOne.y"
              {
